...
public class BlockIronLadder extends BlockModBase {
	 ...
	 */
	protected static final AxisAlignedBB LAD_AABB_NORTH = new AxisAlignedBB(0.0D, 0.0D, 0.75D, 1.0D, 1.0D, 1.0D);/*
																													 * Utils
																													 * .
																													 * creatNewAABB
																													 * (
	...
	protected BlockStateContainer createBlockState() {
		return new BlockStateContainer(this, new IProperty[] { FACING, TOP, PROP, });
	}
