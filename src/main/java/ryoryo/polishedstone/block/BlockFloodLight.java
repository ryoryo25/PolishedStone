...
//		if(h > 0 && h < 20)
//		{
//			world.setBlockState(Utils.getFront(facing, pos.down(h), 3), Register.blockFloodLightPart.getDefaultState(), 2);
//		}
//
...
//			world.playSound(Utils.getPlayer(), pos, SoundEvents.ENTITY_ITEM_PICKUP, SoundCategory.BLOCKS, 0.4F, 1.8F); //for debug
//
////			world.setBlockMetadataWithNotify(pos, next[meta], 3);
//			int h = this.setLight(world, pos, Utils.getRightFacing(facing));
//			if(h > 0 && h < 20)
//			{
//				world.setBlockState(Utils.getFront(Utils.getRightFacing(facing), pos.down(h), 3), Register.blockFloodLightPart.getDefaultState()/*, next[meta]*/, 2);
//			}
//			return true;
//		}
//		else
...
//			if(h > 0 && h < 20)
//			{
//				world.setBlockState(Utils.getFront(facing, pos.down(h), 3), Register.blockFloodLightPart.getDefaultState()/*, meta*/, 2);
//				if(PSV2Core.isDebug)
//					world.playSound(Utils.getPlayer(), pos, SoundEvents.UI_BUTTON_CLICK, SoundCategory.BLOCKS, 0.3F, 0.5F); //for debug
//			}
...
//					world.playSound(Utils.getPlayer(), pos, SoundEvents.UI_BUTTON_CLICK, SoundCategory.BLOCKS, 0.3F, 0.5F); //for debug
//			}
////			world.notifyBlockUpdate(pos, state, Register.blockFloodLightPart.getDefaultState(), 2);
//		}
//	}
//
//	@Override
...
//		{
//			Block ID = world.getBlockState(Utils.getFront(facing, pos.down(height - 1), 3)).getBlock();
