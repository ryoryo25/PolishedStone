...
public class BlockSafetyFence extends Block
{
	...
	{
		if(Utils.isAirMaterial(world.getBlockState(pos.up()))/*.isSideSolid(world, pos, EnumFacing.DOWN)*/)
			return false;
		else
			return true;
	}
	...
	{
		if(Utils.isAirMaterial(world.getBlockState(pos.down()))/*.isSideSolid(world, pos, EnumFacing.UP)*/)
			return false;
		else
			return true;
	}
//
//	private static boolean getRightIsThis(IBlockState state, IBlockAccess world, BlockPos pos)
//	{
//		EnumFacing facing = state.getValue(FACING);
//		if(world.getBlockState(Utils.getRightPos(facing, pos)).getBlock() == Register.blockSafetyFence)
//			return true;
//		else
//			return false;
//	}
//
//	private static boolean getLeftIsThis(IBlockState state, IBlockAccess world, BlockPos pos)
//	{
//		EnumFacing facing = state.getValue(FACING);
//		if(world.getBlockState(Utils.getLeftPos(facing, pos)).getBlock() == Register.blockSafetyFence)
//			return true;
//		else
//			return false;
//	}
