...
// world.setBlockToAir(pos);
// }
// else if(pos.getY() - 2 > 0 && world.isAirBlock(pos.down()) &&
...
// {
// int l = world.getBlockMetadata((X + getOffsetX(meta)), (Y + i), (Z +
// getOffsetZ(meta)));
// if(l == meta)
// end = true;
// }
...
// { Utils.getHeldItemStackOffhand(player),
// Utils.getHeldItemStackMainhand(player) };
//
...
// {
// world.setBlockState(pos, state.withProperty(VISIBLE,
