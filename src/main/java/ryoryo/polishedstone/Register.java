...
//	public static Item item
	...
	public static void preInit()
	{
		...
		PSV2Core.REGISTER.registerBlock(BLOCK_POLISHED_STONE, new ItemBlockPolishedStone(), Locations.POLISHED_STONE, BlockPolishedStone.EnumType.getLength() - 2, Locations.POISHED_STONES, ItemBlockPolishedStone.NAMES);
		PSV2Core.REGISTER.registerBlock(BLOCK_COLORED_LIGHT, new ItemBlockMeta(BLOCK_COLORED_LIGHT, EnumColor.COLOR_WOOL), Locations.COLORED_LIGHT, EnumColor.getLength(), Locations.COLORED_LIGHTS, EnumColor.COLOR_WOOL);
		PSV2Core.REGISTER.registerBlock(BLOCK_NEW_PATH, new ItemBlockMeta(BLOCK_NEW_PATH, BlockNewPath.PathType.NAMES), Locations.NEW_PATH, PathType.getLength(), Locations.NEW_PATHS, BlockNewPath.PathType.NAMES);
		PSV2Core.REGISTER.registerBlock(BLOCK_NEW_FLOWER, new ItemBlockMeta(BLOCK_NEW_FLOWER, BlockNewFlower.NewFlowerType.NAMES), Locations.NEW_FLOWER, NewFlowerType.getLength(), Locations.NEW_FLOWERS, BlockNewFlower.NewFlowerType.NAMES);
		PSV2Core.REGISTER.registerBlock(BLOCK_GLOWSTONE_GENERATOR, new ItemBlock(BLOCK_GLOWSTONE_GENERATOR), Locations.GLOWSTONE_GENE, 8, Locations.GLOWSTONE_GENES);
		PSV2Core.REGISTER.registerBlock(BLOCK_DUMMY_BARRIER, "dummy_barrier");
		PSV2Core.REGISTER.registerBlock(BLOCK_BLACK_QUARTZ, new ItemBlockBlackQuartz(), Locations.BLACK_QUARTZ, ItemBlockBlackQuartz.NAMES.length, Locations.BLACK_QUARTZS, ItemBlockBlackQuartz.NAMES);
//		PSV2Core.REGISTER.registerSmallStairs(BLOCK_SS_BLACK_QUARTZ_BLOCK, "black_quartz_block");
		...
		PSV2Core.REGISTER.registerBlock(BLOCK_DECORATION, new ItemBlockMeta(Register.BLOCK_DECORATION, BlockType.NAMES), Locations.DECORATION, BlockType.getLength(), Locations.DECORATIONS, BlockDecoration.BlockType.NAMES);
		...
		PSV2Core.REGISTER.registerBlock(BLOCK_METAL, new ItemBlockMeta(BLOCK_METAL, BlockMetal.MaterialType.NAMES), Locations.METAL, BlockMetal.MaterialType.getLength(), Locations.METALS, BlockMetal.MaterialType.NAMES);
		PSV2Core.REGISTER.registerBlock(BLOCK_SLIME_REMOVAL_TORCH, "slime_removal_torch");
		PSV2Core.REGISTER.registerBlock(BLOCK_NEW_ORE, new ItemBlockMeta(BLOCK_NEW_ORE, BlockNewOre.MaterialType.NAMES), Locations.NEW_ORE, BlockNewOre.MaterialType.getLength(), Locations.NEW_ORES, BlockNewOre.MaterialType.NAMES);
		PSV2Core.REGISTER.registerBlock(BLOCK_IRON_CHAIN, "iron_chain");
		PSV2Core.REGISTER.registerBlock(BLOCK_ANCHOR_BOLT, "anchor_bolt");
		PSV2Core.REGISTER.registerBlock(BLOCK_IRON_PLATE, new ItemBlockMeta(BLOCK_IRON_PLATE, BlockIronPlate.PlateType.NAMES), Locations.IRON_PLATE, PlateType.getLength(), Locations.IRON_PLATES, BlockIronPlate.PlateType.NAMES);
...
//		PSV2Core.REGISTER.registerBlock(blockFloodLight, "flood_light");
		PSV2Core.REGISTER.registerBlock(BLOCK_FAUCET, new ItemBlockFaucet(), Locations.FAUCET, 2, Locations.FAUCETS);
		...
		PSV2Core.REGISTER.registerBlock(BLOCK_STREET_GUTTER, new ItemBlockStreetGutter(), Locations.LATERAL_GROOVE, 5, Locations.LATERAL_GROOVES, ItemBlockStreetGutter.NAMES);
		...
		PSV2Core.REGISTER.registerBlock(BLOCK_NEW_GRAVEL, new ItemBlockMeta(BLOCK_NEW_GRAVEL, BlockNewGravel.EnumType.NAMES), Locations.NEW_GRAVEL, BlockNewGravel.EnumType.getLength(), Locations.NEW_GRAVELS, BlockNewGravel.EnumType.NAMES);
		PSV2Core.REGISTER.registerBlock(BLOCK_PAVING_STONE, new ItemBlockMeta(BLOCK_PAVING_STONE, BlockPavingStone.EnumType.NAMES), Locations.PAVING_STONE, BlockPavingStone.EnumType.getLength(), Locations.PAVING_STONES, BlockPavingStone.EnumType.NAMES);
		...
		PSV2Core.REGISTER.registerBlock(BLOCK_COMPRESSED_BOOKSHELF, new ItemBlockCompressedBookshelf(), Locations.COMPRESSED_BOOKSHELF, 2, Locations.COMPRESSED_BOOKSHELFS, ItemBlockCompressedBookshelf.NAMES);
		PSV2Core.REGISTER.registerBlock(BLOCK_THREE_PILLARS, new ItemBlockThreePillars(), Locations.THREE_PILLARS, 2, Locations.THREE_PILLARSS, ItemBlockThreePillars.NAMES);
		...
		PSV2Core.REGISTER.registerBlock(BLOCK_DUMMY_CABLE, new ItemBlockMeta(BLOCK_DUMMY_CABLE, BlockDummyCable.EnumType.NAMES), Locations.DUMMY_CABLE, BlockDummyCable.EnumType.getLength(), Locations.DUMMY_CABLES, BlockDummyCable.EnumType.NAMES);
		PSV2Core.REGISTER.registerBlock(BLOCK_POLISHED_STONE_COLORED, new ItemBlockMeta(BLOCK_POLISHED_STONE_COLORED, EnumColor.COLOR_WOOL), Locations.POLISHED_STONE_COLORED, EnumColor.getLength(), Locations.POLISHED_STONE_COLOREDS, EnumColor.COLOR_WOOL);
		PSV2Core.REGISTER.registerBlock(BLOCK_LAMP, new ItemBlockMeta(BLOCK_LAMP, BlockLamp.MaterialType.NAMES), Locations.LAMP, BlockLamp.MaterialType.getLength(), Locations.LAMPS, BlockLamp.MaterialType.NAMES);
		...
		PSV2Core.REGISTER.registerBlock(BLOCK_CHROMA_KEY_BACK, new ItemBlockMeta(BLOCK_CHROMA_KEY_BACK, EnumColor.COLOR_WOOL), Locations.CHROMA_KEY_BACK, EnumColor.getLength(), Locations.CHROMA_KEY_BACKS, EnumColor.COLOR_WOOL);
		PSV2Core.REGISTER.registerBlock(BLOCK_STONE_SLAB, (ItemBlock) new ItemSlab(BLOCK_STONE_SLAB, BLOCK_STONE_SLAB, BLOCK_DOUBLE_STONE_SLAB).setUnlocalizedName("stone_slab"), Locations.STONE_SLAB, BlockModStoneSlab.Type.getLength(), Locations.STONE_SLABS, BlockModStoneSlab.Type.NAMES);
		PSV2Core.REGISTER.registerBlock(BLOCK_DOUBLE_STONE_SLAB, (ItemBlock) new ItemBlockMeta(BLOCK_DOUBLE_STONE_SLAB, BlockModStoneSlab.Type.NAMES), Locations.DOUBLE_STONE_SLAB, BlockModStoneSlab.Type.getLength(), Locations.DOUBLE_STONE_SLABS, BlockModStoneSlab.Type.NAMES);
		...
		PSV2Core.REGISTER.registerBlock(BLOCK_VOID_TELEPORTER, new ItemBlockMeta(BLOCK_VOID_TELEPORTER, BlockVoidTeleporter.VoidType.NAMES), Locations.VOID_TELEPORTER, BlockVoidTeleporter.VoidType.getLength(), Locations.VOID_TELEPORTERS, BlockVoidTeleporter.VoidType.NAMES);
		...
		//Items Registry
		PSV2Core.REGISTER.registerItem(ITEM_TWEAKED_DYE, Locations.TWEAKED_DYE, ItemTweakedDye.NAMES.length, Locations.TWEAKED_DYES, ItemTweakedDye.NAMES);
		PSV2Core.REGISTER.registerItem(ITEM_MATERIAL, Locations.MATERIAL, ItemMaterial.NAMES.length, Locations.MATERIALS, ItemMaterial.NAMES);
