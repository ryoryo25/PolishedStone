...
import ryoryo.polishedstone.block.BlockIronPlate.PlateType;
...
import ryoryo.polishedstone.block.BlockNewPath.PathType;
...
import ryoryo.polishedstone.util.Locations;
...
{
	//Blocks
	public static final Block BLOCK_BRICK_WALL = new BlockBaseWall(Blocks.BRICK_BLOCK);
	public static final Block BLOCK_GRANITE_WALL = new BlockBaseWall(Blocks.STONE/*.getDefaultState().withProperty(BlockStone.VARIANT, BlockStone.EnumType.GRANITE).getBlock()*/, "granite");
	public static final Block BLOCK_SMOOTH_GRANITE_WALL = new BlockBaseWall(Blocks.STONE, "smooth_granite");
	public static final Block BLOCK_DIORITE_WALL = new BlockBaseWall(Blocks.STONE, "diorite");
	public static final Block BLOCK_SMOOTH_DIORITE_WALL = new BlockBaseWall(Blocks.STONE, "smooth_diorite");
	public static final Block BLOCK_ANDESITE_WALL = new BlockBaseWall(Blocks.STONE, "andesite");
	public static final Block BLOCK_SMOOTH_ANDESITE_WALL = new BlockBaseWall(Blocks.STONE, "smooth_andesite");
...
//	public static final Block blockFloodLightPart = new BlockFloodLightPart();
	...
	public static final Block BLOCK_LATERAL_GROOVE = new BlockLateralGroove();
	...
	public static final Block BLOCK_GLASS_OAK_DOOR = new BlockBaseDoor("glass_oak", PSV2Core.TAB_MOD);
	public static final Block BLOCK_GLASS_SPRUCE_DOOR = new BlockBaseDoor("glass_spruce", PSV2Core.TAB_MOD);
	public static final Block BLOCK_GLASS_BIRCH_DOOR = new BlockBaseDoor("glass_birch", PSV2Core.TAB_MOD);
	public static final Block BLOCK_GLASS_JUNGLE_DOOR = new BlockBaseDoor("glass_jungle", PSV2Core.TAB_MOD);
	public static final Block BLOCK_GLASS_ACACIA_DOOR = new BlockBaseDoor("glass_acacia", PSV2Core.TAB_MOD);
	public static final Block BLOCK_GLASS_DARK_OAK_DOOR = new BlockBaseDoor("glass_dark_oak", PSV2Core.TAB_MOD);
	public static final Block BLOCK_GLASS_IRON_DOOR = new BlockBaseDoor(Material.IRON, "glass_iron", PSV2Core.TAB_MOD, SoundType.METAL);
	...
	public static final Item ITEM_INSTANT_FOOD = new ItemBaseFood(2, 2.0F, false, "instant_food", PSV2Core.TAB_MOD, 4);
	public static final Item ITEM_RAW_MEAT_WITH_BONE = new ItemBaseFood(5, 2.4F, true, "raw_meat_with_bone", PSV2Core.TAB_MOD, 128);
	public static final Item ITEM_COOKED_MEAT_WITH_BONE = new ItemBaseFood(20, 20F, true, "cooked_meat_with_bone", PSV2Core.TAB_MOD, 128).setPotionEffect(new PotionEffect(Potion.getPotionById(LibPotionId.SATURATION), (int) Utils.minuteToTick(2F), 2), 1.0F);
...
//	public static Item item
	...
	public static final SoundEvent SOUND_IRON_CHAIN = new SoundEvent(Utils.makeModLocation("chain"));
	public static final SoundEvent SOUND_GUN_FIRE = new SoundEvent(Utils.makeModLocation("gun_fire"));

	public static void preInit()
	{
		String vm = "vending_machine_";
		//Blocks Registry
		Utils.registerBlock(BLOCK_BRICK_WALL, "brick_wall");
		Utils.registerBlock(BLOCK_GRANITE_WALL, "granite_wall");
		Utils.registerBlock(BLOCK_SMOOTH_GRANITE_WALL, "smooth_granite_wall");
		Utils.registerBlock(BLOCK_DIORITE_WALL, "diorite_wall");
		Utils.registerBlock(BLOCK_SMOOTH_DIORITE_WALL, "smooth_diorite_wall");
		Utils.registerBlock(BLOCK_ANDESITE_WALL, "andesite_wall");
		Utils.registerBlock(BLOCK_SMOOTH_ANDESITE_WALL, "smooth_andesite_wall");
		Utils.registerBlock(BLOCK_POLISHED_STONE, new ItemBlockPolishedStone(), Locations.POLISHED_STONE, BlockPolishedStone.EnumType.getLength() - 2, Locations.POISHED_STONES, ItemBlockPolishedStone.NAMES);
		Utils.registerBlock(BLOCK_COLORED_LIGHT, new ItemBlockMeta(BLOCK_COLORED_LIGHT, EnumColor.COLOR_WOOL), Locations.COLORED_LIGHT, EnumColor.getLength(), Locations.COLORED_LIGHTS, EnumColor.COLOR_WOOL);
		Utils.registerBlock(BLOCK_NEW_PATH, new ItemBlockMeta(BLOCK_NEW_PATH, BlockNewPath.PathType.NAMES), Locations.NEW_PATH, PathType.getLength(), Locations.NEW_PATHS, BlockNewPath.PathType.NAMES);
		Utils.registerBlock(BLOCK_NEW_FLOWER, new ItemBlockMeta(BLOCK_NEW_FLOWER, BlockNewFlower.NewFlowerType.NAMES), Locations.NEW_FLOWER, NewFlowerType.getLength(), Locations.NEW_FLOWERS, BlockNewFlower.NewFlowerType.NAMES);
		...
		Utils.registerBlock(BLOCK_VM_DY_DO, new ItemBlockVendingMachine(BLOCK_VM_DY_DO), vm + TexType.DYDO.getName());
		Utils.registerBlock(BLOCK_VM_ITO_EN, new ItemBlockVendingMachine(BLOCK_VM_ITO_EN), vm + TexType.ITO_EN.getName());
		Utils.registerBlock(BLOCK_VM_SUICA, new ItemBlockVendingMachine(BLOCK_VM_SUICA), vm + TexType.SUICA.getName());
		Utils.registerBlock(BLOCK_VM_MAX_COFFEE, new ItemBlockVendingMachine(BLOCK_VM_MAX_COFFEE), vm + TexType.MAX_COFFEE.getName());
		Utils.registerBlock(BLOCK_LOCKER, new ItemBlockVendingMachine(BLOCK_LOCKER), vm + TexType.LOCKER.getName());
		Utils.registerBlock(BLOCK_YELLOW_LINE, "yellow_line");
		Utils.registerBlock(BLOCK_DECORATION, new ItemBlockMeta(Register.BLOCK_DECORATION, BlockType.NAMES), Locations.DECORATION, BlockType.getLength(), Locations.DECORATIONS, BlockDecoration.BlockType.NAMES);
		Utils.registerBlock(BLOCK_INVISIBLE_BUTTON, "invisible_button");
		Utils.registerBlock(BLOCK_RUSTY_RAIL1, "rusty_rail_1");
		Utils.registerBlock(BLOCK_RUSTY_RAIL2, "rusty_rail_2");
		Utils.registerBlock(BLOCK_RUSTY_RAIL3, "rusty_rail_3");
		Utils.registerBlock(BLOCK_RUSTY_WOOD, "rusty_wood");
		Utils.registerBlock(BLOCK_METAL, new ItemBlockMeta(BLOCK_METAL, BlockMetal.MaterialType.NAMES), Locations.METAL, BlockMetal.MaterialType.getLength(), Locations.METALS, BlockMetal.MaterialType.NAMES);
		Utils.registerBlock(BLOCK_SLIME_REMOVAL_TORCH, "slime_removal_torch");
		Utils.registerBlock(BLOCK_NEW_ORE, new ItemBlockMeta(BLOCK_NEW_ORE, BlockNewOre.MaterialType.NAMES), Locations.NEW_ORE, BlockNewOre.MaterialType.getLength(), Locations.NEW_ORES, BlockNewOre.MaterialType.NAMES);
		Utils.registerBlock(BLOCK_IRON_CHAIN, "iron_chain");
		Utils.registerBlock(BLOCK_ANCHOR_BOLT, "anchor_bolt");
		Utils.registerBlock(BLOCK_IRON_PLATE, new ItemBlockMeta(BLOCK_IRON_PLATE, BlockIronPlate.PlateType.NAMES), Locations.IRON_PLATE, PlateType.getLength(), Locations.IRON_PLATES, BlockIronPlate.PlateType.NAMES);
		Utils.registerBlock(BLOCK_IRON_PLATE_STAIRS, "iron_plate_stairs");
		Utils.registerBlock(BLOCK_SAFETY_FENCE, "safety_fence");
		Utils.registerBlock(BLOCK_IRON_LADDER, "iron_ladder");
		Utils.registerBlock(BLOCK_STEPLADDER, "stepladder");
//		Utils.registerBlock(blockFloodLight, "flood_light");
		Utils.registerBlock(BLOCK_FAUCET, new ItemBlockFaucet(), Locations.FAUCET, 2, Locations.FAUCETS);
		Utils.registerBlock(BLOCK_RUNNING_WATER, "running_water");
		Utils.registerBlock(BLOCK_LATTICE_OAK, "lattice_oak");
		Utils.registerBlock(BLOCK_LATTICE_SPRUCE, "lattice_spruce");
		Utils.registerBlock(BLOCK_LATTICE_BIRCH, "lattice_birch");
		Utils.registerBlock(BLOCK_LATTICE_JUNGLE, "lattice_jungle");
		Utils.registerBlock(BLOCK_LATTICE_ACACIA, "lattice_acacia");
		Utils.registerBlock(BLOCK_LATTICE_DARK_OAK, "lattice_dark_oak");
		Utils.registerBlock(BLOCK_LATTICE_NETHER_BRICK, "lattice_nether_brick");
		Utils.registerBlock(BLOCK_FENCE_SLAB_OAK, "fence_slab_oak");
		Utils.registerBlock(BLOCK_FENCE_SLAB_SPRUCE, "fence_slab_spruce");
		Utils.registerBlock(BLOCK_FENCE_SLAB_BIRCH, "fence_slab_birch");
		Utils.registerBlock(BLOCK_FENCE_SLAB_JUNGLE, "fence_slab_jungle");
		Utils.registerBlock(BLOCK_FENCE_SLAB_ACACIA, "fence_slab_acacia");
		Utils.registerBlock(BLOCK_FENCE_SLAB_DARK_OAK, "fence_slab_dark_oak");
		Utils.registerBlock(BLOCK_FENCE_SLAB_NETHER_BRICK, "fence_slab_nether_brick");
		Utils.registerBlock(BLOCK_LATERAL_GROOVE, new ItemBlockLateralGroove(), Locations.LATERAL_GROOVE, 5, Locations.LATERAL_GROOVES, ItemBlockLateralGroove.NAMES);
		Utils.registerBlock(BLOCK_FL_DARK, "fluorescent_light_dark");
		Utils.registerBlock(BLOCK_FL_BRIGHT, "fluorescent_light_bright");
		Utils.registerBlock(BLOCK_FL_BRIGHTER, "fluorescent_light_brighter");
		Utils.registerBlock(BLOCK_TEMPORARY, new ItemBlockTemporary(), "temporary_block");
		Utils.registerBlock(BLOCK_SLAB_RAIL, "slab_rail");
		Utils.registerBlock(BLOCK_NEW_GRAVEL, new ItemBlockMeta(BLOCK_NEW_GRAVEL, BlockNewGravel.EnumType.NAMES), Locations.NEW_GRAVEL, BlockNewGravel.EnumType.getLength(), Locations.NEW_GRAVELS, BlockNewGravel.EnumType.NAMES);
		Utils.registerBlock(BLOCK_PAVING_STONE, new ItemBlockMeta(BLOCK_PAVING_STONE, BlockPavingStone.EnumType.NAMES), Locations.PAVING_STONE, BlockPavingStone.EnumType.getLength(), Locations.PAVING_STONES, BlockPavingStone.EnumType.NAMES);
		Utils.registerBlock(BLOCK_SHADE_GLASS, "shade_glass");
		Utils.registerBlock(BLOCK_HARDENED_SHADE_GLASS, "hardened_shade_glass");
		Utils.registerBlock(BLOCK_COMPRESSED_BOOKSHELF, new ItemBlockCompressedBookshelf(), Locations.COMPRESSED_BOOKSHELF, 2, Locations.COMPRESSED_BOOKSHELFS, ItemBlockCompressedBookshelf.NAMES);
		Utils.registerBlock(BLOCK_THREE_PILLARS, new ItemBlockThreePillars(), Locations.THREE_PILLARS, 2, Locations.THREE_PILLARSS, ItemBlockThreePillars.NAMES);
		Utils.registerBlock(BLOCK_EARTHEN_PIPE, "earthen_pipe");
		Utils.registerBlock(BLOCK_HARDENED_SHADE_GLASS_DOOR, new ItemBlockDoor(BLOCK_HARDENED_SHADE_GLASS_DOOR), "hardened_shade_glass_door");
		Utils.registerBlock(BLOCK_LOCKABLE_DOOR, new ItemBlockDoor(BLOCK_LOCKABLE_DOOR), "lockable_door");
		Utils.registerBlock(BLOCK_DUMMY_CABLE, new ItemBlockMeta(BLOCK_DUMMY_CABLE, BlockDummyCable.EnumType.NAMES), Locations.DUMMY_CABLE, BlockDummyCable.EnumType.getLength(), Locations.DUMMY_CABLES, BlockDummyCable.EnumType.NAMES);
		Utils.registerBlock(BLOCK_POLISHED_STONE_COLORED, new ItemBlockMeta(BLOCK_POLISHED_STONE_COLORED, EnumColor.COLOR_WOOL), Locations.POLISHED_STONE_COLORED, EnumColor.getLength(), Locations.POLISHED_STONE_COLOREDS, EnumColor.COLOR_WOOL);
		Utils.registerBlock(BLOCK_LAMP, new ItemBlockMeta(BLOCK_LAMP, BlockLamp.MaterialType.NAMES), Locations.LAMP, BlockLamp.MaterialType.getLength(), Locations.LAMPS, BlockLamp.MaterialType.NAMES);
		Utils.registerBlock(BLOCK_GLASS_OAK_DOOR, new ItemBlockDoor(BLOCK_GLASS_OAK_DOOR), "glass_oak_door");
		Utils.registerBlock(BLOCK_GLASS_SPRUCE_DOOR, new ItemBlockDoor(BLOCK_GLASS_SPRUCE_DOOR), "glass_spruce_door");
		Utils.registerBlock(BLOCK_GLASS_BIRCH_DOOR, new ItemBlockDoor(BLOCK_GLASS_BIRCH_DOOR), "glass_birch_door");
		Utils.registerBlock(BLOCK_GLASS_JUNGLE_DOOR, new ItemBlockDoor(BLOCK_GLASS_JUNGLE_DOOR), "glass_jungle_door");
		Utils.registerBlock(BLOCK_GLASS_ACACIA_DOOR, new ItemBlockDoor(BLOCK_GLASS_ACACIA_DOOR), "glass_acacia_door");
		Utils.registerBlock(BLOCK_GLASS_DARK_OAK_DOOR, new ItemBlockDoor(BLOCK_GLASS_DARK_OAK_DOOR), "glass_dark_oak_door");
		Utils.registerBlock(BLOCK_GLASS_IRON_DOOR, new ItemBlockDoor(BLOCK_GLASS_IRON_DOOR), "glass_iron_door");
		Utils.registerBlock(BLOCK_CHROMA_KEY_BACK, new ItemBlockMeta(BLOCK_CHROMA_KEY_BACK, EnumColor.COLOR_WOOL), Locations.CHROMA_KEY_BACK, EnumColor.getLength(), Locations.CHROMA_KEY_BACKS, EnumColor.COLOR_WOOL);
		Utils.registerBlock(BLOCK_STONE_SLAB, (ItemBlock) new ItemSlab(BLOCK_STONE_SLAB, BLOCK_STONE_SLAB, BLOCK_DOUBLE_STONE_SLAB).setUnlocalizedName("stone_slab"), Locations.STONE_SLAB, BlockModStoneSlab.Type.getLength(), Locations.STONE_SLABS, BlockModStoneSlab.Type.NAMES);
		Utils.registerBlock(BLOCK_DOUBLE_STONE_SLAB, (ItemBlock) new ItemBlockMeta(BLOCK_DOUBLE_STONE_SLAB, BlockModStoneSlab.Type.NAMES), Locations.DOUBLE_STONE_SLAB, BlockModStoneSlab.Type.getLength(), Locations.DOUBLE_STONE_SLABS, BlockModStoneSlab.Type.NAMES);
		Utils.registerBlock(BLOCK_CROP_ONION, "crop_onion");
		Utils.registerBlock(BLOCK_CROP_JAPANESE_RADISH, "crop_japanese_radish");
		Utils.registerBlock(BLOCK_CROP_CABBAGE, "crop_cabbage");
		Utils.registerBlock(BLOCK_CROP_STICKY_RICE, "crop_sticky_rice");
		Utils.registerBlock(BLOCK_CROP_TOMATO, "crop_tomato");
		Utils.registerBlock(BLOCK_CROP_EGGPLANT, "crop_eggplant");
		Utils.registerBlock(BLOCK_VOID_TELEPORTER, new ItemBlockMeta(BLOCK_VOID_TELEPORTER, BlockVoidTeleporter.VoidType.NAMES), Locations.VOID_TELEPORTER, BlockVoidTeleporter.VoidType.getLength(), Locations.VOID_TELEPORTERS, BlockVoidTeleporter.VoidType.NAMES);
		...
		//Items Registry
		Utils.registerItem(ITEM_TWEAKED_DYE, Locations.TWEAKED_DYE, ItemTweakedDye.NAMES.length, Locations.TWEAKED_DYES, ItemTweakedDye.NAMES);
		Utils.registerItem(ITEM_MATERIAL, Locations.MATERIAL, ItemMaterial.NAMES.length, Locations.MATERIALS, ItemMaterial.NAMES);
		Utils.registerItem(ITEM_INSTANT_FOOD, "instant_food");
		Utils.registerItem(ITEM_RAW_MEAT_WITH_BONE, "meat_with_bone_raw");
		Utils.registerItem(ITEM_COOKED_MEAT_WITH_BONE, "meat_with_bone_cooked");
		Utils.registerItem(ITEM_SPINACH_CAN, "spinach_can");
		Utils.registerItem(ITEM_SOLID_MILK, "solid_milk");
		Utils.registerItem(ITEM_REGENERATE, "heart_of_regeneration");
		Utils.registerItem(ITEM_ARMOR_DECORATIVE_HAZMAT_HELMET, dh + EnumArmorType.HELMET.getName());
		Utils.registerItem(ITEM_ARMOR_DECORATIVE_HAZMAT_CHEST, dh + EnumArmorType.CHESTPLATE.getName());
		Utils.registerItem(ITEM_ARMOR_DECORATIVE_HAZMAT_LEG, dh + EnumArmorType.LEGGINGS.getName());
		Utils.registerItem(ITEM_ARMOR_DECORATIVE_HAZMAT_BOOTS, dh + EnumArmorType.BOOTS.getName());
		Utils.registerItem(ITEM_ARMOR_SAFETY_MET, sc + EnumArmorType.HELMET.getName());
		Utils.registerItem(ITEM_ARMOR_WORK_CLOTHES, sc + EnumArmorType.CHESTPLATE.getName());
		Utils.registerItem(ITEM_ARMOR_SAFETY_BELT, sc + EnumArmorType.LEGGINGS.getName());
		Utils.registerItem(ITEM_ARMOR_SAFETY_BOOTS, sc + EnumArmorType.BOOTS.getName());
		Utils.registerItem(ITEM_ARMOR_LIFE_JACKET, "life_jacket");
		Utils.registerItem(ITEM_INVINCIBLE_SWORD, "invincible_sword");
		Utils.registerItem(ITEM_INVINCIBLE_BOW, "invincible_bow");
		Utils.registerItem(ITEM_BEDROCK_CORE, "bedrock_core");
		Utils.registerItem(ITEM_RANDOM_BOX, "random_box");
//		Utils.registerItem(itemNewDye, "new_dye", EnumColor.getLength());
		Utils.registerItem(ITEM_ZABUTON, "zabuton", 16);
		Utils.registerItem(ITEM_ARMOR_INVINCIBLE_HELMET, ia + EnumArmorType.HELMET.getName());
		Utils.registerItem(ITEM_ARMOR_INVINCIBLE_CHEST, ia + EnumArmorType.CHESTPLATE.getName());
		Utils.registerItem(ITEM_ARMOR_INVINCIBLE_LEG, ia + EnumArmorType.LEGGINGS.getName());
		Utils.registerItem(ITEM_ARMOR_INVINCIBLE_BOOTS, ia + EnumArmorType.BOOTS.getName());
		Utils.registerItem(ITEM_DAMAGE_FOOD_MINI, "damage_food_mini");
		Utils.registerItem(ITEM_DAMAGE_FOOD_NORMAL, "damage_food_normal");
		Utils.registerItem(ITEM_DAMAGE_FOOD_BIG, "damage_food_big");
		Utils.registerItem(ITEM_DAMAGE_FOOD_HUGE, "damage_food_huge");
		Utils.registerItem(ITEM_SEED_ONION, "seed_onion");
		Utils.registerItem(ITEM_SEED_JAPANESE_RADISH, "seed_japanese_radish");
		Utils.registerItem(ITEM_SEED_CABBAGE, "seed_cabbage");
		Utils.registerItem(ITEM_SEED_TOMATO, "seed_tomato");
		Utils.registerItem(ITEM_SEED_EGGPLANT, "seed_eggplant");
		Utils.registerItem(ITEM_ONION, "onion");
		Utils.registerItem(ITEM_JAPANESE_RADISH, "japanese_radish");
		Utils.registerItem(ITEM_CABBAGE, "cabbage");
		Utils.registerItem(ITEM_STICKY_RICE, "sticky_rice");
		Utils.registerItem(ITEM_TOMATO, "tomato");
		Utils.registerItem(ITEM_EGGPLANT, "eggplant");

		//Entity Registry
		Utils.registerModEntity(EntityZabuton.class, "zabuton", LibEntityId.ENTITY_ID_ZABUTON, PSV2Core.INSTANCE, 80, 3, true);
	...
	public static void init()
	{
		...
		//レシピ
		//バニラサポート
		Utils.addRecipe("core_to_bedrock", new ItemStack(Blocks.BEDROCK, 8), "PPP", "PbP", "PPP", 'P', new ItemStack(BLOCK_POLISHED_STONE, 1, 0), 'b', new ItemStack(ITEM_BEDROCK_CORE, 1, WILDCARD_VALUE));
		Utils.addShapelessRecipe("glowstone_to_dusts", new ItemStack(Items.GLOWSTONE_DUST, 4), Blocks.GLOWSTONE);
		Utils.addShapelessRecipe("quartz_block_to_items",new ItemStack(Items.QUARTZ, 4), Blocks.QUARTZ_BLOCK);
		Utils.addShapelessRecipe("all_glasses_to_normal_glass", new ItemStack(Blocks.GLASS, 1), "blockGlass");
		Utils.addShapelessRecipe("all_glass_panes_to_normal_glass_pane", new ItemStack(Blocks.GLASS_PANE, 1), "paneGlass");
		Utils.addShapelessRecipe("all_wools_to_white_wool", new ItemStack(Blocks.WOOL, 1, 0), "blockWool");
		Utils.addRecipe("strings_to_webs", new ItemStack(Blocks.WEB, 5), "s s", " s ", "s s", 's', Items.STRING);
		Utils.addShapelessRecipe("wool_to_strings", new ItemStack(Items.STRING, 4), "blockWool");
		Utils.addShapelessRecipe("brown_mushrooms_to_mushroom_stew", new ItemStack(Items.MUSHROOM_STEW, 1), Blocks.BROWN_MUSHROOM, Blocks.BROWN_MUSHROOM, Blocks.BROWN_MUSHROOM, Items.BOWL);
		Utils.addShapelessRecipe("red_mushrooms_to_mushroom_stew", new ItemStack(Items.MUSHROOM_STEW, 1), Blocks.RED_MUSHROOM, Blocks.RED_MUSHROOM, Blocks.RED_MUSHROOM, Items.BOWL);
		Utils.addRecipe("lapis_book_to_normal_enchanted_book", new ItemStack(Items.ENCHANTED_BOOK, 1), "lll", "lbl", "lll", 'l', new ItemStack(Items.DYE, 1, EnumColor.BLUE.getDyeNumber()), 'b', Items.BOOK);
		Utils.addRecipe("wither_to_egg", Utils.getSpawnEggItemStack(EntityWither.class, 1), "sss", "SSS", " S ", 's', new ItemStack(Items.SKULL, 1, 1), 'S', Blocks.SOUL_SAND);
		Utils.addRecipe("snow_golem_to_egg", Utils.getSpawnEggItemStack(EntitySnowman.class, 1), "P", "S", "S", 'P', "blockPumpkin", 'S', Blocks.SNOW);
		Utils.addRecipe("iron_golem_to_egg", Utils.getSpawnEggItemStack(EntityIronGolem.class, 1), " P ", "III", " I ", 'P', "blockPumpkin", 'I', Blocks.IRON_BLOCK);
		Utils.addRecipe("easier_dispenser", new ItemStack(Blocks.DISPENSER, 1), "CCC", "CbC", "CrC", 'C', "cobblestone", 'b', new ItemStack(Items.BOW, 1, WILDCARD_VALUE), 'r', "dustRedstone");
		Utils.addShapelessRecipe("dropper_bow_to_dispenser", new ItemStack(Blocks.DISPENSER, 1), Blocks.DROPPER, new ItemStack(Items.BOW, 1, WILDCARD_VALUE));
		Utils.addRecipe("easier_carrot_stick", new ItemStack(Items.CARROT_ON_A_STICK, 1), "f ", " c", 'f', new ItemStack(Items.FISHING_ROD, 1, WILDCARD_VALUE), 'c', Items.CARROT);
		Utils.addRecipe("lever_to_piston", new ItemStack(Blocks.PISTON, 1), "PPP", "CiC", "ClC", 'P', "plankWood", 'C', "cobblestone", 'i', "ingotIron", 'l', Blocks.LEVER);
		Utils.addRecipe("ore_dict_beacon", new ItemStack(Blocks.BEACON, 1), "GGG", "GnG", "OOO", 'G', "blockGlass", 'n', Items.NETHER_STAR, 'O', "obsidian");
		Utils.addShapelessRecipe("shapeless_lit_pumpkin", new ItemStack(Blocks.LIT_PUMPKIN, 1), Blocks.PUMPKIN, Blocks.TORCH);
		Utils.addShapelessRecipe("ore_dict_shapeless_lit_pumpkin", new ItemStack(Blocks.LIT_PUMPKIN, 1), "blockPumpkin", "torch");
		Utils.addShapelessRecipe("snow_block_to_balls", new ItemStack(Items.SNOWBALL, 4), Blocks.SNOW);
		Utils.addRecipe("golden_apples_to_enchanted", new ItemStack(Items.GOLDEN_APPLE, 1, 1), "ggg", "ggg", "ggg", 'g', Items.GOLDEN_APPLE);
		Utils.addShapelessRecipe("wall_vine_to_mossy_wall", new ItemStack(Blocks.COBBLESTONE_WALL, 1, 1), new ItemStack(Blocks.COBBLESTONE_WALL, 1, 0), Blocks.VINE);
		Utils.addShapelessRecipe("tallgrass_dirt_to_grass_", new ItemStack(Blocks.GRASS, 1), "blockTallgrass", Blocks.DIRT);
		Utils.addShapelessRecipe("bottle_ender_eye_to_exp_bottle", new ItemStack(Items.EXPERIENCE_BOTTLE, 3), Items.GLASS_BOTTLE, Items.GLASS_BOTTLE, Items.GLASS_BOTTLE, Items.ENDER_EYE);
		Utils.addRecipe("blaze_rod_powder_to_torch", new ItemStack(Blocks.TORCH, 32), "p", "r", 'p', Items.BLAZE_POWDER, 'r', Items.BLAZE_ROD);
		Utils.addRecipe("blaze_rod_coals_to_torch", new ItemStack(Blocks.TORCH, 16), "c", "r", 'c', Items.COAL, 'r', Items.BLAZE_ROD);
		Utils.addRecipe("blaze_rod_coal_to_torch", new ItemStack(Blocks.TORCH, 16), "c", "r", 'c', "coal", 'r', Items.BLAZE_ROD);
		Utils.addRecipe("blaze_rod_charcoal_to_torch", new ItemStack(Blocks.TORCH, 16), "c", "r", 'c', "charcoal", 'r', Items.BLAZE_ROD);
		Utils.addRecipe("cobble_ender_pearl_to_end_stone", new ItemStack(Blocks.END_STONE, 8), "CCC", "CeC", "CCC", 'C', "cobblestone", 'e', Items.ENDER_PEARL);
		Utils.addRecipe("end_things_to_end_portal_frame", new ItemStack(Blocks.END_PORTAL_FRAME, 1), " e ", "ppp", "EEE", 'e', Items.ENDER_EYE, 'p', Items.ENDER_PEARL, 'E', Blocks.END_STONE);
		Utils.addRecipe("tallgrass_to_waterlily", new ItemStack(Blocks.WATERLILY, 2), "T T", "TTT", " T ", 'T', "blockTallgrass");
		Utils.addShapelessRecipe("disassembly_melon", new ItemStack(Items.MELON, 9), Blocks.MELON_BLOCK);
		//苗木
		Utils.addShapelessRecipe("brown_to_spruce_sapling", new ItemStack(Blocks.SAPLING, 1, 1), new ItemStack(Blocks.SAPLING, 1, 0), new ItemStack(Items.DYE, 1, EnumColor.BROWN.getDyeNumber()));
		Utils.addShapelessRecipe("white_to_birch_sapling", new ItemStack(Blocks.SAPLING, 1, 2), new ItemStack(Blocks.SAPLING, 1, 0), new ItemStack(Items.DYE, 1, EnumColor.WHITE.getDyeNumber()));
		Utils.addShapelessRecipe("pink_to_jungle_sapling", new ItemStack(Blocks.SAPLING, 1, 3), new ItemStack(Blocks.SAPLING, 1, 0), new ItemStack(Items.DYE, 1, EnumColor.PINK.getDyeNumber()));
		Utils.addShapelessRecipe("red_to_acacia_sapling", new ItemStack(Blocks.SAPLING, 1, 4), new ItemStack(Blocks.SAPLING, 1, 0), new ItemStack(Items.DYE, 1, EnumColor.RED.getDyeNumber()));
		Utils.addShapelessRecipe("black_to_dark_oak_sapling", new ItemStack(Blocks.SAPLING, 1, 5), new ItemStack(Blocks.SAPLING, 1, 0), new ItemStack(Items.DYE, 1, EnumColor.BLACK.getDyeNumber()));
		//赤砂
		Utils.addShapelessRecipe("red_dye_to_red_sand", new ItemStack(Blocks.SAND, 1, 1), new ItemStack(Blocks.SAND, 1, 0), new ItemStack(Items.DYE, 1, EnumColor.RED.getDyeNumber()));
		//花
		Utils.addShapelessRecipe("poppy_yellow_to_sun_flower", new ItemStack(Blocks.DOUBLE_PLANT, 1, 0), new ItemStack(Blocks.RED_FLOWER, 1, 0), EnumColor.YELLOW.getDyeOreName());
		Utils.addShapelessRecipe("poppy_magenta_to_syringa", new ItemStack(Blocks.DOUBLE_PLANT, 1, 1), new ItemStack(Blocks.RED_FLOWER, 1, 0), EnumColor.MAGENTA.getDyeOreName());
		Utils.addShapelessRecipe("poppy_red_to_rose", new ItemStack(Blocks.DOUBLE_PLANT, 1, 4), new ItemStack(Blocks.RED_FLOWER, 1, 0), EnumColor.RED.getDyeOreName());
		Utils.addShapelessRecipe("poppy_pink_to_paeonia", new ItemStack(Blocks.DOUBLE_PLANT, 1, 5), new ItemStack(Blocks.RED_FLOWER, 1, 0), EnumColor.PINK.getDyeOreName());
		//金床壊れかけ
		Utils.addRecipe("fewer_iron_to_chipped_anvil", new ItemStack(Blocks.ANVIL, 1, 1), " II", " i ", "iii", 'I', Blocks.IRON_BLOCK, 'i', Items.IRON_INGOT);
		Utils.addRecipe("fewest_iron_to_damaged_anvil", new ItemStack(Blocks.ANVIL, 1, 2), "  I", " i ", "iii", 'I', Blocks.IRON_BLOCK, 'i', Items.IRON_INGOT);
		//ショートカットレシピ
		//各種原木x3 → 各種半ブロックx24
		for(int i = 0; i < 6; i++)
		{
			Utils.addRecipe("log_" + EnumPlanks.byMeta(i).getName() + "_to_slab_" + EnumPlanks.byMeta(i).getName(), new ItemStack(Blocks.WOODEN_SLAB, 24, i), "LLL", 'L', EnumPlanks.getLogStackByPlanksMeta(1, i));
		}
		//原木x8 → チェストx4
		Utils.addRecipe("logs_to_chests", new ItemStack(Blocks.CHEST, 4), "LLL", "L L", "LLL", 'L', "logWood");
		//木材x7 → はしごx6
		Utils.addRecipe("planks_to_ladders", new ItemStack(Blocks.LADDER, 6), "L L", "LLL", "L L", 'L', "plankWood");
		//原木x7 → はしごx24
		Utils.addRecipe("logs_ladders", new ItemStack(Blocks.LADDER, 24), "L L", "LLL", "L L", 'L', "logWood");
		//原木x6 → トラップドアx8
		Utils.addRecipe("logs_to_trapdoors", new ItemStack(Blocks.TRAPDOOR, 8), "   ", "LLL", "LLL", 'L', "logWood");
		//原木x2 → 棒x16
		Utils.addRecipe("logs_to_sticks", new ItemStack(Items.STICK, 16), "L", "L", 'L', "logWood");
		//原木x3 → ボウルx16
		Utils.addRecipe("logs_to_bowls", new ItemStack(Items.BOWL, 16), "L L", " L ", 'L', "logWood");
		//サトウキビx3, 革 → 本
		Utils.addShapelessRecipe("reeds_to_book", new ItemStack(Items.BOOK), Items.REEDS, Items.REEDS, Items.REEDS, Items.LEATHER);
		//赤石x2, 光石x2 → レッドストーンランプ
		Utils.addShapelessRecipe("red_glow_dusts_to_redstone_lump", new ItemStack(Blocks.REDSTONE_LAMP), "dustRedstone", "dustRedstone", "dustRedstone", "dustRedstone", "dustGlowstone", "dustGlowstone", "dustGlowstone", "dustGlowstone");
		//階段
...
//		Utils.addMiniRecipeStairs(Blocks.QUARTZ_STAIRS, new ItemStack(Blocks.QUARTZ_BLOCK));
		...
		Utils.addShapelessRecipe("gravel_to_flint", new ItemStack(Items.FLINT), Blocks.GRAVEL);

		//Mod Blocks
		Utils.addRecipe("stones_to_polished_stone", new ItemStack(BLOCK_POLISHED_STONE, 2, 0), "S ", " S", 'S', Blocks.STONE);
		Utils.addShapelessRecipe("lit_off_polished_stone", new ItemStack(BLOCK_POLISHED_STONE, 1, 1), new ItemStack(BLOCK_POLISHED_STONE, 1, 0));
		for(int i = 0; i < 16; i++)
		{
			Utils.addRecipe("light_" + EnumColor.byMeta(i).getName(), new ItemStack(BLOCK_COLORED_LIGHT, 8, i), "GdG", "GgG", "GiG", 'G', "blockGlass", 'd', EnumColor.byMeta(i).getDyeOreName(), 'g', Blocks.GLOWSTONE, 'i', Items.IRON_INGOT);
		}
		Utils.addRecipe("glowstone_generator", new ItemStack(BLOCK_GLOWSTONE_GENERATOR, 1), "dld", "SSS", "dSd", 'd', Items.DIAMOND, 'l', new ItemStack(Items.DYE, 1, EnumColor.BLUE.getDyeNumber()), 'S', Blocks.STONE);
		//ミニ階段
		...
		Utils.addRecipe("locker", new ItemStack(BLOCK_LOCKER, 1), "gl", "ii", "ii", 'g', EnumColor.GRAY.getDyeOreName(), 'l', EnumColor.LIGHT_GRAY.getDyeOreName(), 'i', "ingotIron");
		Utils.addShapelessRecipe("yellow_line", new ItemStack(BLOCK_YELLOW_LINE, 1), "stone", EnumColor.YELLOW.getDyeOreName());
		Utils.addRecipe("dummy_solar", new ItemStack(BLOCK_METAL, 4, BlockMetal.MaterialType.DUMMY_SOLAR.getMeta()), "bGb", "GbG", "did", 'b', EnumColor.BLUE.getDyeOreName(), 'G', "blockGlass", 'd', EnumColor.BLACK.getDyeOreName(), 'i', "ingotIron");
		Utils.addRecipe("block_of_charcoal", new ItemStack(BLOCK_METAL, 1, BlockMetal.MaterialType.CHARCOAL.getMeta()), "ccc", "ccc", "ccc", 'c', new ItemStack(Items.COAL, 1, 1));
		Utils.addShapelessRecipe("invisible_button", new ItemStack(BLOCK_INVISIBLE_BUTTON, 1), "ingotEnderSteel", "dustRedstone");
		Utils.addShapelessRecipe("rusty_rail_1", new ItemStack(BLOCK_RUSTY_RAIL1, 1), Blocks.RAIL, Items.WATER_BUCKET);
		Utils.addShapelessRecipe("rusty_rail_2", new ItemStack(BLOCK_RUSTY_RAIL2, 1), BLOCK_RUSTY_RAIL1, Items.WATER_BUCKET);
		Utils.addShapelessRecipe("rusty_rail_3", new ItemStack(BLOCK_RUSTY_RAIL3, 1), BLOCK_RUSTY_RAIL2, Items.WATER_BUCKET);
		Utils.addShapelessRecipe("rusty_wood", new ItemStack(BLOCK_RUSTY_WOOD, 1), BLOCK_RUSTY_RAIL3, Items.WATER_BUCKET);
		Utils.addRecipe("slab_rail", new ItemStack(BLOCK_SLAB_RAIL, 16), "i i", "iPi", "i i", 'i', "ingotIron", 'P', new ItemStack(BLOCK_PAVING_STONE, 1, BlockPavingStone.EnumType.NORMAL.getMeta()));
		Utils.addRecipeWall("brick", BLOCK_BRICK_WALL, new ItemStack(Blocks.BRICK_BLOCK));
		Utils.addRecipeWall("granite", BLOCK_GRANITE_WALL, new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.GRANITE.getMetadata()));
		Utils.addRecipeWall("smooth_granite", BLOCK_SMOOTH_GRANITE_WALL, new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.GRANITE_SMOOTH.getMetadata()));
		Utils.addRecipeWall("diorite", BLOCK_DIORITE_WALL, new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.DIORITE.getMetadata()));
		Utils.addRecipeWall("smooth_diorite", BLOCK_SMOOTH_DIORITE_WALL, new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.DIORITE_SMOOTH.getMetadata()));
		Utils.addRecipeWall("andesite", BLOCK_ANDESITE_WALL, new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.ANDESITE.getMetadata()));
		Utils.addRecipeWall("smooth_andesite", BLOCK_SMOOTH_ANDESITE_WALL, new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.ANDESITE_SMOOTH.getMetadata()));
		...
		Utils.addRecipe("lattice_nether_brick", new ItemStack(BLOCK_LATTICE_NETHER_BRICK, 8), "NN", "NN", "NN", 'N', Blocks.NETHER_BRICK);
		Utils.addRecipe("fluorescent_light_dark", new ItemStack(BLOCK_FL_DARK, 4), "GgG", 'G', "blockGlass", 'g', "dustGlowstone");
		Utils.addRecipe("fluorescent_light_bright", new ItemStack(BLOCK_FL_BRIGHT, 4), " g ", "GgG", 'G', "blockGlass", 'g', "dustGlowstone");
		Utils.addRecipe("fluorescent_light_brighter", new ItemStack(BLOCK_FL_BRIGHTER, 4), " g ", "GgG", " g ", 'G', "blockGlass", 'g', "dustGlowstone");
		Utils.addShapelessRecipe("shade_glass", new ItemStack(BLOCK_SHADE_GLASS, 1), "blockGlass", EnumColor.BLACK.getDyeOreName());
		Utils.addRecipe("hardened_shade_glass", new ItemStack(BLOCK_HARDENED_SHADE_GLASS, 8), "SSS", "SBS", "SSS", 'S', BLOCK_SHADE_GLASS, 'B', Blocks.BEDROCK);
		Utils.addRecipe("hardened_shade_glass_door", new ItemStack(BLOCK_HARDENED_SHADE_GLASS_DOOR, 1), "HH", "HH", "HH", 'H', BLOCK_HARDENED_SHADE_GLASS);
		Utils.addShapelessRecipe("paving_gravel", new ItemStack(BLOCK_NEW_GRAVEL, 2, BlockNewGravel.EnumType.PAVING.getMeta()), new ItemStack(Blocks.DIRT, 1, BlockDirt.DirtType.DIRT.getMetadata()), Blocks.GRAVEL);
		Utils.addShapelessRecipe("paving_stone", new ItemStack(BLOCK_PAVING_STONE, 2, BlockPavingStone.EnumType.NORMAL.getMeta()), new ItemStack(Blocks.STONE, 1, BlockStone.EnumType.STONE.getMetadata()), new ItemStack(BLOCK_NEW_GRAVEL, 1, BlockNewGravel.EnumType.PAVING.getMeta()));
		Utils.addRecipe("powered_paving_stone", new ItemStack(BLOCK_PAVING_STONE, 1, BlockPavingStone.EnumType.POWERED.getMeta()), "r", "P", 'r', "dustRedstone", 'P', new ItemStack(BLOCK_PAVING_STONE, 1, BlockPavingStone.EnumType.NORMAL.getMeta()));
		Utils.addRecipe("three_pillars_normal", new ItemStack(BLOCK_THREE_PILLARS, 16, BlockThreePillars.EnumShape.NORMAL_UP_SINGLE.getMetaDummy()), "S S", "S S", 'S', "stone");
		Utils.addRecipe("three_pillars_black", new ItemStack(BLOCK_THREE_PILLARS, 16, BlockThreePillars.EnumShape.BLACK_UP_SINGLE.getMetaDummy()), "SbS", "SbS", 'S', "stone", 'b', EnumColor.BLACK.getDyeOreName());
		Utils.addRecipe("lockable_door", new ItemStack(BLOCK_LOCKABLE_DOOR, 1), "ii", "ik", "ii", 'i', "ingotIron", 'k', new ItemStack(ITEM_MATERIAL, 1, 17));
		...
		Utils.addRecipe("glass_iron_door", new ItemStack(BLOCK_GLASS_IRON_DOOR, 3), "ii", "BB", "ii", 'i', "ingotIron", 'B', Blocks.IRON_BARS);
		for(int i = 0; i < EnumColor.getLength(); i++)
		{
			Utils.addShapelessRecipe("colored_polished_stone_" + EnumColor.byMeta(i).getName(), new ItemStack(BLOCK_POLISHED_STONE_COLORED, 1, i), EnumColor.byMeta(i).getDyeOreName(), new ItemStack(BLOCK_POLISHED_STONE, 1, 0));
			Utils.addRecipe("chroma_key_back_" + EnumColor.byMeta(i).getName(), new ItemStack(BLOCK_CHROMA_KEY_BACK, 9, i), "CCC", "CCC", "CCC", 'C', new ItemStack(Blocks.CONCRETE, 1, i));
		}
		Utils.addRecipe("iron_chain", new ItemStack(BLOCK_IRON_CHAIN, 16), "i", "i", "i", 'i', "ingotIron");
		Utils.addRecipe("anchor_bolt", new ItemStack(BLOCK_ANCHOR_BOLT, 1), "iI", 'i', "ingotIron", 'I', BLOCK_IRON_CHAIN);
		Utils.addRecipe("iron_plate_normal", new ItemStack(BLOCK_IRON_PLATE, 9, 0), " I ", "iii", 'I', BLOCK_IRON_CHAIN, 'i', "ingotIron");
		Utils.addShapelessRecipe("iron_plate_rusty", new ItemStack(BLOCK_IRON_PLATE, 8, 1), Items.WATER_BUCKET, new ItemStack(BLOCK_IRON_PLATE, 1, 0), new ItemStack(BLOCK_IRON_PLATE, 1, 0), new ItemStack(BLOCK_IRON_PLATE, 1, 0), new ItemStack(BLOCK_IRON_PLATE, 1, 0),
		...
		Utils.addRecipe("iron_plate_stairs", new ItemStack(BLOCK_IRON_PLATE_STAIRS, 3), "P  ", " P ", "  P", 'P', new ItemStack(BLOCK_IRON_PLATE, 1, 0));
		Utils.addRecipe("iron_ladder", new ItemStack(BLOCK_IRON_LADDER, 7), "P P", "PPP", "P P", 'P', new ItemStack(BLOCK_IRON_PLATE, 1, 0));
		Utils.addRecipe("safety_fence", new ItemStack(BLOCK_SAFETY_FENCE, 6), "PPP", "PPP", 'P', new ItemStack(BLOCK_IRON_PLATE, 1, 0));
		Utils.addRecipe("stepladder", new ItemStack(BLOCK_STEPLADDER, 1), "iLi", "iLi", "iLi", 'i', "ingotIron", 'L', Blocks.LADDER);
		Utils.addRecipe("faucet_0", new ItemStack(BLOCK_FAUCET, 1, 0), "rri", "iii", "iri", 'r', "dustRedstone", 'i', "ingotIron");
		Utils.addRecipe("faucet_1", new ItemStack(BLOCK_FAUCET, 1, 1), "iii", "iri", "rri", 'r', "dustRedstone", 'i', "ingotIron");
		Utils.addRecipe("compressed_bookshelf_x1", new ItemStack(BLOCK_COMPRESSED_BOOKSHELF, 1, 0), "BBB", "B B", "BBB", 'B', Blocks.BOOKSHELF);
		Utils.addRecipe("compressed_bookshelf_x2", new ItemStack(BLOCK_COMPRESSED_BOOKSHELF, 1, 1), "BB", 'B', new ItemStack(BLOCK_COMPRESSED_BOOKSHELF, 1, 0));
		Utils.addRecipe("black_quartz_normal", new ItemStack(BLOCK_BLACK_QUARTZ, 1, 0), "bb", "bb", 'b', "gemQuartzBlack");
		Utils.addShapelessRecipe("disassembly_black_quartz", new ItemStack(ITEM_MATERIAL, 4, 18), new ItemStack(BLOCK_BLACK_QUARTZ, 1, 0));
		Utils.addRecipe("black_quartz_lines", new ItemStack(BLOCK_BLACK_QUARTZ, 2, 2), "B", "B", 'B', new ItemStack(BLOCK_BLACK_QUARTZ, 1, 0));

		//Mod Items
		Utils.addShapelessRecipe("tweaked_dye_blue", new ItemStack(ITEM_TWEAKED_DYE, 1, 2), new ItemStack(BLOCK_NEW_FLOWER, 1, 0));
		Utils.addShapelessRecipe("tweaked_dye_black", new ItemStack(ITEM_TWEAKED_DYE, 1, 0), new ItemStack(BLOCK_NEW_FLOWER, 1, 1));
		Utils.addShapelessRecipe("ink_to_tweaked_dye_black", new ItemStack(ITEM_TWEAKED_DYE, 4, 0), new ItemStack(Items.DYE, 1, EnumColor.BLACK.getDyeNumber()));
		Utils.addShapelessRecipe("cacao_to_tweaked_dye_brown", new ItemStack(ITEM_TWEAKED_DYE, 16, 1), new ItemStack(Items.DYE, 1, EnumColor.BROWN.getDyeNumber()));
		Utils.addShapelessRecipe("lapis_to_tweaked_dye_blue", new ItemStack(ITEM_TWEAKED_DYE, 32, 2), new ItemStack(Items.DYE, 1, EnumColor.BLUE.getDyeNumber()));
		Utils.addShapelessRecipe("bone_meals_to_tweaked_dye_white", new ItemStack(ITEM_TWEAKED_DYE, 4, 3), new ItemStack(Items.DYE, 1, EnumColor.WHITE.getDyeNumber()));
		Utils.addShapelessRecipe("red_green_to_brown", new ItemStack(ITEM_TWEAKED_DYE, 2, 1), EnumColor.RED.getDyeOreName(), EnumColor.GREEN.getDyeOreName());
		Utils.addShapelessRecipe("red_yellow_blue_to_brown", new ItemStack(ITEM_TWEAKED_DYE, 4, 1), EnumColor.RED.getDyeOreName(), EnumColor.RED.getDyeOreName(), EnumColor.BLUE.getDyeOreName(), EnumColor.YELLOW.getDyeOreName());
		for(int i = 0; i < EnumColor.getLength(); i++)
		{
			Utils.addRecipe("zabuton_" + EnumColor.byDyeDamage(i).getName(), new ItemStack(ITEM_ZABUTON, 1, i), "s ", "WW", 's', Items.STRING, 'W', new ItemStack(Blocks.WOOL, 1, EnumColor.byDyeDamage(i).getWoolNumber()));
		}
		Utils.addShapelessRecipe("empty_spawn_egg", new ItemStack(Items.SPAWN_EGG, 8), Items.IRON_INGOT, Items.IRON_INGOT, Items.REDSTONE);
		Utils.addRecipe("material_railway_rusty_x4", new ItemStack(ITEM_MATERIAL, 1, 15), "rr", "rr", 'r', new ItemStack(ITEM_MATERIAL, 1, 14));
		Utils.addRecipe("material_railway_rusty_x16", new ItemStack(ITEM_MATERIAL, 1, 16), "rr", "rr", 'r', new ItemStack(ITEM_MATERIAL, 1, 15));
		Utils.addRecipe("key", new ItemStack(ITEM_MATERIAL, 1, 17), "ggg", "  g", 'g', "ingotGold");
		Utils.addRecipe("decorative_hazmat_helmet", new ItemStack(ITEM_ARMOR_DECORATIVE_HAZMAT_HELMET, 1), " o ", "sGs", "sBs", 'o', EnumColor.ORANGE.getDyeOreName(), 's', Items.SLIME_BALL, 'G', "blockGlass", 'B', Blocks.IRON_BARS);
		Utils.addRecipe("decorative_hazmat_chest", new ItemStack(ITEM_ARMOR_DECORATIVE_HAZMAT_CHEST, 1), "s s", "sos", "sos", 's', Items.SLIME_BALL, 'o', EnumColor.ORANGE.getDyeOreName());
		Utils.addRecipe("decorative_hazmat_leg", new ItemStack(ITEM_ARMOR_DECORATIVE_HAZMAT_LEG, 1), "sos", "s s", "s s", 's', Items.SLIME_BALL, 'o', EnumColor.ORANGE.getDyeOreName());
		Utils.addRecipe("decorative_hazmat_boots", new ItemStack(ITEM_ARMOR_DECORATIVE_HAZMAT_BOOTS, 1), "s s", "s s", "sWs", 's', Items.SLIME_BALL, 'W', "blockWool");
		...
		Utils.addRecipe("safety_helmet", new ItemStack(ITEM_ARMOR_SAFETY_MET, 1), "yly", "sWs", 'y', EnumColor.YELLOW.getDyeOreName(), 'l', Items.LEATHER_HELMET, 's', Items.STRING, 'W', "blockWool");
		Utils.addRecipe("safety_chest", new ItemStack(ITEM_ARMOR_WORK_CLOTHES, 1), "C C", "CCC", "lll", 'C', EnumColor.CYAN.getWoolOreName(), 'l', Items.LEATHER);
		Utils.addRecipe("safety_leg", new ItemStack(ITEM_ARMOR_SAFETY_BELT, 1), "lll", "  I", 'l', Items.LEATHER, 'I', BLOCK_IRON_CHAIN);
		Utils.addRecipe("safety_boots", new ItemStack(ITEM_ARMOR_SAFETY_BOOTS, 1), "lbl", "i i", 'l', Items.LEATHER, 'b', EnumColor.BLACK.getDyeOreName(), 'i', "ingotIron");
		Utils.addRecipe("life_jacket", new ItemStack(ITEM_ARMOR_LIFE_JACKET, 1), "P P", "lll", "PPP", 'P', "plankWood", 'l', Items.LEATHER);
...
//		Utils.removeSmeltingRecipe(new ItemStack(Blocks.LOG, 1, 0), new ItemStack(Items.COAL, 1, 1));
		...
		if(!ModConfig.increasingResistance.isEmpty())
		{
			for(String loc : ModConfig.increasingResistance)
			{
				...
				Utils.addLog("Setted " + loc + "'s resistance to 10000!");
			}
		}
		...
		if(!ModCompat.COMPAT_QUARK)
		{
			...
			Utils.addInfo("Quark is installed, so skip register.");

		if(Utils.isOreDictLoaded("ingotTin"))
		{
			Utils.addRecipe("tin_to_bucket", new ItemStack(Items.BUCKET, 1), "t t", " t ", 't', "ingotTin");
			Utils.addRecipe("tin_to_shears", new ItemStack(Items.SHEARS, 1), " t", "t ", 't', "ingotTin");
			Utils.addRecipe("tin_to_piston", new ItemStack(Blocks.PISTON, 1), "PPP", "CtC", "CrC", 'P', "plankWood", 'C', "cobblestone", 't', "ingotTin", 'r', "dustRedstone");
			Utils.addRecipe("tin_to_minecart", new ItemStack(Items.MINECART, 1), "t t", "ttt", 't', "ingotTin");
		}
		if(Utils.isOreDictLoaded("ingotCopper"))
		{
			Utils.addRecipe("copper_to_bucket", new ItemStack(Items.BUCKET, 1), "c c", " c ", 'c', "ingotCopper");
			Utils.addRecipe("copper_to_shears", new ItemStack(Items.SHEARS, 1), " c", "c ", 'c', "ingotCopper");
			Utils.addRecipe("copper_to_piston", new ItemStack(Blocks.PISTON, 1), "PPP", "CcC", "CrC", 'P', "plankWood", 'C', "cobblestone", 'c', "ingotCopper", 'r', "dustRedstone");
			Utils.addRecipe("copper_to_minecart", new ItemStack(Items.MINECART, 1), "c c", "ccc", 'c', "ingotCopper");
		}
		if(Utils.isOreDictLoaded("ingotLead"))
		{
			Utils.addRecipe("lead_to_bucket", new ItemStack(Items.BUCKET, 1), "l l", " l ", 'l', "ingotLead");
			Utils.addRecipe("lead_to_shears", new ItemStack(Items.SHEARS, 1), " l", "l ", 'l', "ingotLead");
			Utils.addRecipe("lead_to_piston", new ItemStack(Blocks.PISTON, 1), "PPP", "ClC", "CrC", 'P', "plankWood", 'C', "cobblestone", 'l', "ingotLead", 'r', "dustRedstone");
			Utils.addRecipe("lead_to_minecart", new ItemStack(Items.MINECART, 1), "l l", "lll", 'l', "ingotLead");
		}
		if(Utils.isOreDictLoaded("ingotSilver"))
		{
			Utils.addRecipe("silver_to_bucket", new ItemStack(Items.BUCKET, 1), "s s", " s ", 's', "ingotSilver");
			Utils.addRecipe("silver_to_shears", new ItemStack(Items.SHEARS, 1), " s", "s ", 's', "ingotSilver");
			Utils.addRecipe("silver_to_piston", new ItemStack(Blocks.PISTON, 1), "PPP", "CsC", "CrC", 'P', "plankWood", 'C', "cobblestone", 's', "ingotSilver", 'r', "dustRedstone");
			Utils.addRecipe("silver_to_minecart", new ItemStack(Items.MINECART, 1), "s s", "sss", 's', "ingotSilver");
		}
		if(Utils.isOreDictLoaded("ingotBronze"))
		{
			Utils.addRecipe("iron_chain_bronze", new ItemStack(BLOCK_IRON_CHAIN, 16), "i", "i", "i", 'i', "ingotBronze");
			Utils.addRecipe("anchor_bolt_bronze", new ItemStack(BLOCK_ANCHOR_BOLT, 1), "iI", 'i', "ingotBronze", 'I', BLOCK_IRON_CHAIN);
			Utils.addRecipe("stepladder_bronze", new ItemStack(BLOCK_STEPLADDER, 1), "iLi", "iLi", "iLi", 'i', "ingotBronze", 'L', Blocks.LADDER);
		}
