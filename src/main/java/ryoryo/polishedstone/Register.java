...
import ryoryo.polishedstone.item.armor.ItemModBaseArmor;
...
//	public static final Block blockFloodLightPart = new BlockFloodLightPart();
	...
	public static final Item ITEM_COOKED_MEAT_WITH_BONE = new ItemModBaseFood(20, 20F, true, "cooked_meat_with_bone", PSV2Core.TAB_MOD, 128).setPotionEffect(new PotionEffect(Potion.getPotionById(LibPotionId.SATURATION), (int) Utils.minuteToTick(2F), 2), 1.0F);
	...
	public static final ItemArmor ITEM_ARMOR_DECORATIVE_HAZMAT_HELMET = new ItemModBaseArmor(ArmorMaterials.DECORATIVE_HAZMAT, EnumArmorType.HELMET, "decorative_hazmat", PSV2Core.TAB_MOD);
	public static final ItemArmor ITEM_ARMOR_DECORATIVE_HAZMAT_CHEST = new ItemModBaseArmor(ArmorMaterials.DECORATIVE_HAZMAT, EnumArmorType.CHESTPLATE, "decorative_hazmat", PSV2Core.TAB_MOD);
	public static final ItemArmor ITEM_ARMOR_DECORATIVE_HAZMAT_LEG = new ItemModBaseArmor(ArmorMaterials.DECORATIVE_HAZMAT, EnumArmorType.LEGGINGS, "decorative_hazmat", PSV2Core.TAB_MOD);
	public static final ItemArmor ITEM_ARMOR_DECORATIVE_HAZMAT_BOOTS = new ItemModBaseArmor(ArmorMaterials.DECORATIVE_HAZMAT, EnumArmorType.BOOTS, "decorative_hazmat", PSV2Core.TAB_MOD);
	...
	public static final ItemArmor ITEM_ARMOR_LIFE_JACKET = new ItemModBaseArmor(ArmorMaterials.LIFE_JACKET, EnumArmorType.CHESTPLATE, "life_jacket", PSV2Core.TAB_MOD);
...
//	public static Item item
	...
	public static final SoundEvent SOUND_IRON_CHAIN = new SoundEvent(ModUtils.makeModLocation("chain"));
	public static final SoundEvent SOUND_GUN_FIRE = new SoundEvent(ModUtils.makeModLocation("gun_fire"));
...
//		Utils.registerItem(itemNewDye, "new_dye", EnumColor.getLength());
		...
		//Entity Registry
		Utils.registerModEntity(EntityZabuton.class, References.MOD_ID, "zabuton", LibEntityId.ENTITY_ID_ZABUTON, PSV2Core.INSTANCE, 80, 3, true);
