...
public class ItemTweakedDye extends ItemDye {
	public static final String[] NAMES = new String[] { EnumColor.BLACK.getName(), EnumColor.BROWN.getName(), EnumColor.BLUE.getName(), EnumColor.WHITE.getName(), "cadmium", "cinnabar" };
