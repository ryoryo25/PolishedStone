...
public class BlockClassTransformer implements IClassTransformer, Opcodes {
	...
	public byte[] transform(String name, String transformedName, byte[] basicClass) {
		...
		PSLoadingPlugin.LOGGER.info("-Found: " + transformedName + "; start transforming");
