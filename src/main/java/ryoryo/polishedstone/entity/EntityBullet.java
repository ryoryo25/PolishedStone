package ryoryo.polishedstone.entity;

// package ryoryo.entity;
//
...
// {
// this(world, shooter.posX, shooter.posY + (double) shooter.getEyeHeight() -
...
// }
//
// public void shoot(Entity shooter, float pitch, float yaw, float velocity,
// float inaccuracy)
// {
// float f = -MathHelper.sin(yaw * 0.017453292F) * MathHelper.cos(pitch *
// 0.017453292F);
// float f1 = -MathHelper.sin(pitch * 0.017453292F);
// float f2 = MathHelper.cos(yaw * 0.017453292F) * MathHelper.cos(pitch *
// 0.017453292F);
...
//
// @Override
// public void shoot(double x, double y, double z, float velocity, float
// inaccuracy)
// {
...
// y = y / (double) f;
// z = z / (double) f;
// x = x + this.rand.nextGaussian() * 0.007499999832361937D * (double)
// inaccuracy;
// y = y + this.rand.nextGaussian() * 0.007499999832361937D * (double)
// inaccuracy;
// z = z + this.rand.nextGaussian() * 0.007499999832361937D * (double)
// inaccuracy;
// x = x * (double) velocity;
// y = y * (double) velocity;
// z = z * (double) velocity;
...
// this.rotationPitch = (float) (MathHelper.atan2(y, (double) f) * (180D /
// Math.PI));
// this.rotationYaw = (float) (MathHelper.atan2(x, z) * (180D / Math.PI));
// this.prevRotationPitch = this.rotationPitch;
// this.prevRotationYaw = this.rotationYaw;
...
// if(this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F)
// {
// float f = MathHelper.sqrt(this.motionX * this.motionX + this.motionZ *
// this.motionZ);
...
//
// if(aabb != Block.NULL_AABB && aabb.offset(pos).contains(new Vec3d(this.posX,
// this.posY, this.posZ)))
// {
// this.inGround = true;
// }
...
// }
//
// if(raytraceresult != null && raytraceresult.entityHit instanceof
// EntityPlayer)
// {
// EntityPlayer player = (EntityPlayer) raytraceresult.entityHit;
//
// if(this.shootingEntity instanceof EntityPlayer && !((EntityPlayer)
...
// this.posZ += this.motionZ;
// float f4 = MathHelper.sqrt(this.motionX * this.motionX + this.motionZ *
// this.motionZ);
// this.rotationYaw = (float) (MathHelper.atan2(this.motionX, this.motionZ) *
// (180D / Math.PI));
//
// for(this.rotationPitch = (float) (MathHelper.atan2(this.motionY, (double) f4)
// * (180D / Math.PI)); this.rotationPitch - this.prevRotationPitch < -180.0F;
...
// this.motionX * 0.25D, this.posY - this.motionY * 0.25D, this.posZ -
// this.motionZ * 0.25D, this.motionX, this.motionY, this.motionZ);
// }
//
// f1 = 0.6F;
// }
...
// if(entity != null)
// {
// float f = MathHelper.sqrt(this.motionX * this.motionX + this.motionY *
...
// {
// float f1 = MathHelper.sqrt(this.motionX * this.motionX + this.motionZ *
// this.motionZ);
//
// if(f1 > 0.0F)
// {
// entitylivingbase.addVelocity(this.motionX * (double) this.knockbackStrength *
// 0.6000000238418579D / (double) f1, 0.1D, this.motionZ * (double)
// this.knockbackStrength * 0.6000000238418579D / (double) f1);
// }
// }
//
...
// this.ticksInAir = 0;
//
// if(!this.world.isRemote && this.motionX * this.motionX + this.motionY *
// this.motionY + this.motionZ * this.motionZ < 0.0010000000474974513D)
// {
// this.setDead();
// }
// }
...
// float f2 = MathHelper.sqrt(this.motionX * this.motionX + this.motionY *
// this.motionY + this.motionZ * this.motionZ);
...
// entity1.getEntityBoundingBox().grow(0.30000001192092896D);
