...
//			}
	...
	public void onSpawn(LivingSpawnEvent.CheckSpawn event)
	{
		...
		if(!ModCompat.COMPAT_CUSTOM_SPAWN)
		{
			...
			Utils.addInfo("Custom Spawn is loaded.");
		...
		if(living != null)
		{
			...
			if(living instanceof EntityCreeper)
			{
				...
				if(source == DamageSource.ON_FIRE)
				{
					...
					world.createExplosion(creeper, creeper.posX, creeper.posY, creeper.posZ, (float) /*creeper.explosionRadius*/3 * f, ModConfig.deathExplosionDestroyTerrain);
				}
			}
		}
	}
