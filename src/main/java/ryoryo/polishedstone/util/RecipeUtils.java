...
public class RecipeUtils {
	...
	/**
	 * 自動販売機レシピ登録 名前の前に"vending_machine_"と足される
	 * 
	 * @param name
	 * @param output
	 * @param dyeOre
	...
	/**
	 * Latticeのレシピ登録 Planks用 名前の前に"lattice_"と足される
	 * 
	 * @param output
	 * @param material
	 */
	...
	/**
	 * FenceSlabのレシピ登録 名前の前に"fence_slab_"と足される
	 * 
	 * @param name
	 * @param output
	 * @param material
	...
	/**
	 * FenceSlabのレシピ登録 Planks用 名前の前に"fence_slab_"と足される
	 * 
	 * @param output
	 * @param planks
	 */
	...
	/**
	 * GlassDoorのレシピ登録 Planks用 名前に"glass_" + planks.getName() + "_door"と足される
	 * 
	 * @param output
	 * @param planks
	 */
