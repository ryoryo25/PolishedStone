...
{
	//MOD
	public static final KeyBinding KEY_FACING_ADJUSTMENT = new KeyBinding(LibUnlocalizedString.KEY_FACING_ADJUSTMENT, Keyboard.KEY_J, LibUnlocalizedString.KEY_CATEGORY);
